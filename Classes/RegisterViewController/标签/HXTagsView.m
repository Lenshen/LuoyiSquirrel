...
- (void)setTagAry:(NSArray *)tagAry delegate:(id)delegate {
    ...
    for (NSArray *iTags in disposeAry) {
        ...
        for (NSDictionary *tagDic in iTags) {
            ...
            float _buttonWith = [tagDic[@"buttonWith"] floatValue];
            ...
            _button.titleLabel.font = [UIFont systemFontOfSize:_titleSize];
            [_button setTitle:tagTitle forState:UIControlStateNormal];
            [_button setTitleColor:_titleColor forState:UIControlStateNormal];
            [_button setBackgroundImage:_normalBackgroundImage forState:UIControlStateNormal];

            [_button setBackgroundImage:_highlightedBackgroundImage forState:UIControlStateHighlighted];
